...
function getWorks(){
    return fetch("https://cdn.contentful.com/spaces/domtj3yma899/environments/master/entries?access_token=aQAzU_rJfX6p0F9jUNWye-twN_EG2Wbbe-THxBg8vWk&&content_type=portfolio")
    .then((res)=>{
     return res.json();
    })
    .then((data)=>{ 
